...
while attemps < 12345677901:
    ...
    if username == 'shruod00' and password =='SHRUOD':
...
\33[1;96m╔═════════════════════════════════════════╗
\033[93m ║ AUTHOR > \x1b[1;91m SHRUOD
\033[32m ║ FB > \x1b[1;97m@VVGGXX
\033[95m ║ GITHUB > \x1b[0;34m SHRUODx
...
def passwrd():
	...
	print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mTOOL -WORK-IRAQ")
	SHADj(f'\033[0;97m╔════════════════════════════════════╗')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SHRUOD-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print('\033[0;94m══════════════════════════════════════════════╗')
				os.system('espeak -a 300 " SHRUOD,  Ok,  id"')
